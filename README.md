...
<p align="center">
  <img src="https://github.com/smrh1379/Robotic_SBU_final_project/blob/main/images/bug-algorithms.jpg" height="200">	
</p>
...
If your are just interested in controllers, there are three distinct Python files which bug algorithms have been coded there.

| Algorithm | Controller |
|--|--|
| *Bug 0* | [`BUG0_controller.py`](https://github.com/smrh1379/Robotic_SBU_final_project/blob/main/bug0.py) |
| *Bug 1* | [`BUG1_controller.py`](https://github.com/smrh1379/Robotic_SBU_final_project/blob/main/bug1.py) |
| *Bug 2* | [`BUG2_controller.py`](https://github.com/smrh1379/Robotic_SBU_final_project/blob/main/bug2.py) |


## Simulation
The simulation results in Webots are as follows. Also you can watch the full videos of the simulations here: [Simulation Videos](https://drive.google.com/drive/folders/1-OXYklDsWVxdKsyIMlP1uyE0GTsatfyD?usp=sharing)
<p align="center">
  <img src="https://github.com/smrh1379/Robotic_SBU_final_project/blob/main/images/map.jpg" height="500">	
</p>

---
### Bug 0 snapshots:
<p align="center">
  <img src="https://github.com/smrh1379/Robotic_SBU_final_project/blob/main/images/bug0_simulation.jpg" width="1000">	
</p>

---
### Bug 1 snapshots:
<p align="center">
  <img src="https://github.com/smrh1379/Robotic_SBU_final_project/blob/main/images/bug1_simulation.jpg" width="1000">	
</p>

---
### Bug 2 snapshots:
<p align="center">
  <img src="https://github.com/smrh1379/Robotic_SBU_final_project/blob/main/images/bug2_simulation.jpg" width="1000">	
</p>
